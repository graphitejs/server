...
describe('<LoginPassword />', () => {
  ...
  beforeEach(() => {
    ...
    wrapper = mount(<LoginPassword mutate= {responseSuccess} />);
    wrapperFailed = mount(<LoginPassword mutate= {responseFailed} />);
    wrapperThrow = mount(<LoginPassword mutate= {responseThrow} />);
  });
  ...
  context('when interactive', () => {
    context('when submit', () => {
      context('when there are loginPassword', () => {
      ...
      context('when not there are loginPassword', () => {
